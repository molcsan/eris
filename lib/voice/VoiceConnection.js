...
class VoiceConnection extends EventEmitter {
    ...
    emit(event, ...args) {
        console.log(`------------------ VoiceConnection emit ${JSON.stringify(event)} ------------------`);
        console.dir(args);
        console.log(`-----------------------------------------------------------------------------------`);
    ...
    connect(data) {
        ...
        this.connectionTimeout = setTimeout(() => {
            if(this.connecting) {
                console.log(`${JSON.stringify(data)} -------------------- /r/n ${JSON.stringify(this)}`)
        ...
        */
        ...
        console.log("Voice connection: " + JSON.stringify(data));
        this.ws.on("open", () => {
            /**
